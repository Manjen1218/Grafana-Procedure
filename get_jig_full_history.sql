DELIMITER //
CREATE OR REPLACE PROCEDURE `get_jig_full_history`(
...
BEGIN
    ...
    read_loop: LOOP
      ...
      SET @sql = CONCAT(
        'INSERT INTO tmp_jig_history (wo, sn, sku, test_station, jig, tbeg, tend, err_id, err_msg) ',
        'SELECT wo, sn, ''', db_name, ''' AS sku, ''', tbl_name, ''' AS test_station, jig, tbeg, tend, err_id, err_msg ',
